...
int main() {
	...
	for (int i = 0; i < events.size(); i++) {
		if (events[i].type == 1) cout << endl << events[i].type << " " << events[i].day << " " << events[i].family1 << " " << events[i].city;
		else cout << endl << events[i].type << " " << events[i].day << " " << events[i].family1 << " " << events[i].family2;
	}
	/*cout << endl;
	for (int i = 1; i <= numOfCities; i++) {
		for (int j = 1; j <= numOfCities; j++)
	...
	for (int i = 1; i <= numOfCities; i++) {
		cout << endl;
		for (pii e : mapList[i]) cout << "{" << i << "," << e.first << "," << e.second << "}";
	}
	*/
}